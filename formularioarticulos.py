                ...
                def consulta_por_codigo(self):
                    ...
                    def listar(self):
                        ...
                        for fila in respuesta:
                            self.scrolled.text1.insert(tk.END, "codigo" +str(fila[0])+"\ndescripcion:"+str(fila[1])+ "\nprecio"+str(fila[2])+ "\n\n")
